...
public class InstructionSetDialog extends JDialog {
	...
	public InstructionSetDialog() {
		...
		{
			JLabel lblInstructionSet = new JLabel("");
			lblInstructionSet.setIcon(new ImageIcon("res\\instruction-set.jpg"));        			
			lblInstructionSet.setBounds(10, 10, 564, 197);
			contentPanel.add(lblInstructionSet);
		}
		{
